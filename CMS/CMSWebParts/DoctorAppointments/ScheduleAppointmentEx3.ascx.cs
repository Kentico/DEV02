...
public partial class CMSWebParts_DoctorAppointments_ScheduleAppointmentEx3 : CMSAbstractWebPart
{
    ...
    protected override void OnLoad(EventArgs e)
    {
        ...
        CSSHelper.RegisterCSSLink(this.Page, "https://cdnjs.cloudflare.com/ajax/libs/semantic-ui/2.1.8/semantic.min.css");
        CSSHelper.RegisterCSSLink(this.Page, "https://code.jquery.com/ui/1.10.4/themes/smoothness/jquery-ui.css");
